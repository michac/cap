...
--
-- Vendored from CDMProbe. The SavedVariables SHAPE is the hard contract; everything
-- below this header is not. Kept byte-identical to the original on purpose, so a diff
-- between the copies shows real divergence rather than reformatting.
